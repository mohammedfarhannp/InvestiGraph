...
class Edge:
    ...
    def draw(self, screen, camera):
        ...
        start_intersect = self.circle_intersection(start, end, self.source.radius * camera.zoom)
        end_intersect = self.circle_intersection(end, start, self.target.radius * camera.zoom)
        ...
        self.draw_arrowhead(screen, end_intersect, start_intersect, color, camera.zoom)
